...
fn main() {
    ...
    let frame: &[u8] = &[
        ...
        0x45, 0x00, 0x00, 0x28, 0x12, 0x34, 0x40, 0x00, 0x40, 0x06, 0x00, 0x00, 10, 0, 0, 1, 10, 0,
        0, 2,
        // TCP: sport=54321, dport=80, seq=1, ack=0, data_offset=5, flags=SYN, window, cksum=0, urg=0
        0xd4, 0x31, 0x00, 0x50, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x50, 0x02, 0xff,
